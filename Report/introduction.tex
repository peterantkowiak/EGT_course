...
illustate differences between pd and hd, influence of neighborhood,spatial structure-> hd and pd, mixed strategies in hd modelle simulation
gives the simulation the expected results???


specific questions Task 1-3
Task 1 influence of spatial structure in pd and hd-> spatial structure benfits cooperators especially in pd
Task 2 influence of different neighborhoods in pd and hd ->  neioghborhoodsize influences the effect of spatial structure
Task 3 influence of mixed strategies in the hd spatial and nonspatial -> mixed change the effect of spatial struckture
